...
let SummaryTable = React.createClass({
	goBack(){
		history.back();
	},
	componentDidMount() {
		...
		if(query.time){
			this.props.dispatch(actions.summaryTableActionAsync({
				jgzj:'全部',
		...
		this.props.dispatch(actions.baseDataActionAsync("0"));
	},
					...
					<div className='table-container'>
						<div className='table-cont'>
							<Table
								...
								loading={this.props.summary.loading}
...
SummaryTable = connect(mapStateToProps)(SummaryTable);
