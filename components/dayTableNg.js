...
let TableNgComponent = React.createClass({
	goBack(){
		history.back();
	},
	componentDidMount() {
		...
		this.props.dispatch(actions.tableNgActionAsync());
		this.props.dispatch(actions.baseDataActionAsync('1'));
	},
...
TableNgComponent = connect(mapStateToProps)(TableNgComponent);

export default TableNgComponent;